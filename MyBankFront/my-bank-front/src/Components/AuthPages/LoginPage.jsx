...
const LoginPage = () => {
    ...
    const login = async (e) => {
        ...
        const result = await axios({
            method: 'post',
            url: 'http://51.250.77.153:9000/jwt/tokens'
            ,
            headers: {
        ...
        const test = await axios({
            method: 'get',
            url: 'http://51.250.77.153:9000/test'
            ,
            headers: {
                "Content-type": "application/json; charset=UTF-8",
        ...
        try {
            checkAdmin = await axios({
                method: 'get',
                url: 'http://51.250.77.153:9000/api/auth/checkAccessAdmin'
                ,
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    "Authorization": jwtAuth,
                ...
                <Button
                    ...
                    <GoogleLogin
                        onSuccess={async credentialResponse => {
                            ...
                            await axios.post("http://51.250.77.153:9000/api/auth/register", usr).then(r => console.log(r))
