...
public class JwtAuthenticationConfigurer extends
    ...
    public void configure(HttpSecurity builder) throws Exception {
        ...
        authenticationProvider.setPreAuthenticatedUserDetailsService
                (new TokenUserService(deactivatedTokenRepository));

        var refreshTokenFilter = new RequestJwtTokensFilter();
        ...
        jwtLogoutFilter.setDeactivatedTokenRepository(deactivatedTokenRepository);
